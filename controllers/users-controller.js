...
const signup = async (req, res, next) => {
    ...
    const { name, email, password, school, schoolDistrict, city, state } =
        req.body;
...
const updateUser = async (req, res, next) => {
    ...
    const { name, email, school, schoolDistrict, city, state } = req.body;
    ...
    user.email = email;
    user.school = school;
    user.schoolDistrict = schoolDistrict;
    user.city = city;
    user.state = state;
